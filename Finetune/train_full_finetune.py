...
model = AutoModelForCausalLM.from_pretrained(
    '/data/LLM Learning/Models/Qwen/Qwen3-0.6B', 
    device_map="auto", 
...
# 加载模型的tokenizer
tokenizer = AutoTokenizer.from_pretrained('/data/LLM Learning/Models/Qwen/Qwen3-0.6B', trust_remote_code=True)
...
args = TrainingArguments(
    output_dir="./output/Qwen3_0.6B",  # 输出目录
